...
int realizarAtendimento(Fila* fila, Historico* h, Atendimento* cabecaListaAtendimentos, char psicologo[100], char data[11], char resumo[500]) {
    ...
    if (cabecaListaAtendimentos->nome[0] == '\0') {
        ...
        strncpy(cabecaListaAtendimentos->data, data, 10);
        cabecaListaAtendimentos->data[10] = '\0';
        ...
        strncpy(novoAtendimento->data, data, 10);
        novoAtendimento->data[10] = '\0';
